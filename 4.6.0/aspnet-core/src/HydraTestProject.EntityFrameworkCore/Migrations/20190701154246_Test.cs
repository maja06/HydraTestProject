    ...
    public partial class Test : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_TableCs", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_TableDs", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_CoreEntityTypeProperties_Tables_ReferenceTableId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CoreEntityPropertyValues_EntityId_EntityTypePropertyId",
                table: "CoreEntityPropertyValues",
                columns: new[] { "EntityId", "EntityTypePropertyId" },
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CoreEntityTypeProperties_ReferenceTableId",
                table: "CoreEntityTypeProperties",
                column: "ReferenceTableId");

            migrationBuilder.CreateIndex(
                name: "IX_CoreEntityTypeProperties_Name_EntityTypeId",
                table: "CoreEntityTypeProperties",
                columns: new[] { "Name", "EntityTypeId" });
